...
> = [
  ["soc-e1", "soc-q", "soc-exposure", "derived_from", 0],
  ["soc-e2", "soc-exposure", "soc-homophily", "causes", 1],
  ["soc-e3", "soc-homophily", "soc-polarization", "mediates", 2],
  ["soc-e4", "soc-exposure", "soc-polarization", "causes", 3],
  ["soc-e5", "soc-diversity", "soc-homophily", "moderates", 4],
  ["soc-e6", "soc-diet", "soc-exposure", "correlates", 5],
  ["soc-e7", "soc-ideology", "soc-exposure", "controls", 6],
  ["soc-e8", "soc-region", "soc-exposure", "controls", 7],
  ["soc-e9", "soc-age", "soc-method-panel", "controls", 0],
  ["soc-e10", "soc-education", "soc-method-panel", "controls", 1],
  ["soc-e11", "soc-income", "soc-method-panel", "controls", 2],
  ["soc-e12", "soc-h1", "soc-method-match", "derived_from", 3],
  ["soc-e13", "soc-h2", "soc-method-panel", "derived_from", 4],
  ["soc-e14", "soc-h3", "soc-method-panel", "derived_from", 5],
  ["soc-e15", "soc-method-match", "soc-result", "measures", 6],
  ["soc-e16", "soc-method-panel", "soc-result", "measures", 7],
  ["soc-e17", "soc-result", "soc-metric", "supports", 0],
  ["soc-e18", "soc-metric", "soc-polarization", "measures", 1],
  ["soc-e19", "soc-trust", "soc-participation", "causes", 2],
  ["soc-e20", "soc-participation", "soc-trust", "causes", 3],
  ["soc-e21", "soc-diversity", "soc-trust", "correlates", 4],
  ["soc-e22", "soc-diet", "soc-homophily", "causes", 5],
  ["soc-e23", "soc-ideology", "soc-polarization", "controls", 6],
  ["soc-e24", "soc-homophily", "soc-result", "supports", 7],
  ["soc-e25", "soc-diversity", "soc-result", "supports", 0],
];
