...
function edge(
  ...
  label: string,
  polarity: ResearchEdge["polarity"] = "positive",
): ResearchEdge {
  return {
    id,
    source,
...
export const zenWorkspaceFixture: ProjectState = {
  ...
  edges: [
    edge("edge-canopy-temp", "variable-canopy", "variable-temperature", "K", "影响"),
    edge("edge-question-canopy", "question-tree", "variable-canopy", "T", "研究对象"),
    edge("edge-canopy-landsat", "variable-canopy", "paper-landsat", "T", "测量依据"),
    edge("edge-canopy-ndvi", "variable-canopy", "method-ndvi", "T", "派生自"),
    edge("edge-canopy-result", "variable-canopy", "result-canopy", "K", "产生"),
    edge("edge-density-temp", "variable-density", "variable-temperature", "K", "控制"),
    edge("edge-result-zhang", "result-canopy", "paper-zhang", "K", "支持"),
    edge("edge-result-nguyen", "result-canopy", "paper-nguyen", "K", "支持"),
    edge("edge-zhang-nguyen", "paper-zhang", "paper-nguyen", "K", "结论冲突", "negative"),
  ],
  evidence: [],
